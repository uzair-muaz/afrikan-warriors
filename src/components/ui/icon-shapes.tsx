...
export const iconShapes = {
  ...
  chat: (
    <>
      <path d="M4.4 4.6h15.2v11.2H8.6L4.4 19.2V4.6Z" />
      <path
        d="M8 9.1h8v1.5H8zm0 3h5.4v1.5H8z"
        fill="var(--color-stage)"
      />
    </>
  ),
  ...
  expand_less: (
    <path d="m6.2 14.8 5.8-5.8 5.8 5.8 1.4-1.4L12 6.2 4.8 13.4 6.2 14.8Z" />
  ),
  ...
  whatsapp: (
    <path d="M12.04 2.04c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.06 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21h.01c5.45 0 9.91-4.45 9.91-9.91-.01-5.46-4.46-9.88-9.93-9.88Zm5.76 14.08c-.24.68-1.41 1.25-1.95 1.33-.5.07-1.13.1-1.82-.12-.42-.13-.95-.31-1.63-.6-2.87-1.24-4.75-4.14-4.89-4.33-.14-.2-1.18-1.57-1.18-3 0-1.42.75-2.13 1.01-2.42.26-.29.57-.36.76-.36.19 0 .38 0 .54.01.17 0 .41-.07.64.49.24.56.82 2.01.89 2.16.07.14.12.31.02.5-.1.2-.15.32-.29.49-.14.16-.3.37-.43.5-.14.14-.29.3-.12.58.16.29.74 1.22 1.59 1.97 1.09.97 2.01 1.27 2.29 1.42.29.14.45.12.62-.07.17-.19.71-.83.9-1.11.19-.28.38-.24.64-.14.26.09 1.66.78 1.95.93.29.14.48.21.55.33.07.12.07.68-.17 1.36Z" />
  ),
